...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.PodSelectorRequirement)(nil), (*core.PodSelectorRequirement)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_PodSelectorRequirement_To_core_PodSelectorRequirement(a.(*v1.PodSelectorRequirement), b.(*core.PodSelectorRequirement), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.PodSelectorRequirement)(nil), (*v1.PodSelectorRequirement)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_PodSelectorRequirement_To_v1_PodSelectorRequirement(a.(*core.PodSelectorRequirement), b.(*v1.PodSelectorRequirement), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_PodSelector_To_core_PodSelector(in *v1.PodSelector, out *core.PodSelector, s conversion.Scope) error {
	...
	out.MatchExpressions = *(*[]core.PodSelectorRequirement)(unsafe.Pointer(&in.MatchExpressions))
	return nil
}
...
func autoConvert_core_PodSelector_To_v1_PodSelector(in *core.PodSelector, out *v1.PodSelector, s conversion.Scope) error {
	out.MatchLabels = *(*map[string]string)(unsafe.Pointer(&in.MatchLabels))
	out.MatchExpressions = *(*[]v1.PodSelectorRequirement)(unsafe.Pointer(&in.MatchExpressions))
	return nil
}
...
func autoConvert_v1_PodSelectorRequirement_To_core_PodSelectorRequirement(in *v1.PodSelectorRequirement, out *core.PodSelectorRequirement, s conversion.Scope) error {
	out.Key = in.Key
	out.Operator = core.PodSelectorOperator(in.Operator)
	out.Values = *(*[]string)(unsafe.Pointer(&in.Values))
	return nil
}

// Convert_v1_PodSelectorRequirement_To_core_PodSelectorRequirement is an autogenerated conversion function.
func Convert_v1_PodSelectorRequirement_To_core_PodSelectorRequirement(in *v1.PodSelectorRequirement, out *core.PodSelectorRequirement, s conversion.Scope) error {
	return autoConvert_v1_PodSelectorRequirement_To_core_PodSelectorRequirement(in, out, s)
}

func autoConvert_core_PodSelectorRequirement_To_v1_PodSelectorRequirement(in *core.PodSelectorRequirement, out *v1.PodSelectorRequirement, s conversion.Scope) error {
	out.Key = in.Key
	out.Operator = v1.PodSelectorOperator(in.Operator)
	out.Values = *(*[]string)(unsafe.Pointer(&in.Values))
	return nil
}

// Convert_core_PodSelectorRequirement_To_v1_PodSelectorRequirement is an autogenerated conversion function.
func Convert_core_PodSelectorRequirement_To_v1_PodSelectorRequirement(in *core.PodSelectorRequirement, out *v1.PodSelectorRequirement, s conversion.Scope) error {
	return autoConvert_core_PodSelectorRequirement_To_v1_PodSelectorRequirement(in, out, s)
}
