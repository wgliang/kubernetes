...
type ResourceAllocationPriority struct {
	Name   string
	scorer func(requested, allocable *schedulernode.Resource, includeVolumes bool, requestedVolumes int, allocatableVolumes int) int64
}
...
func (r *ResourceAllocationPriority) PriorityMap(
	pod *v1.Pod,
	meta interface{},
	nodeInfo *schedulernode.NodeInfo) (schedulerapi.HostPriority, error) {
	node := nodeInfo.Node()
	if node == nil {
	...
	var requested schedulernode.Resource
...
func getNonZeroRequests(pod *v1.Pod) *schedulernode.Resource {
