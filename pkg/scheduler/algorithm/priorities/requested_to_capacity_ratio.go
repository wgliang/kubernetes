...
func buildRequestedToCapacityRatioScorerFunction(scoringFunctionShape FunctionShape) func(*schedulernode.Resource, *schedulernode.Resource, bool, int, int) int64 {
	...
	return func(requested, allocable *schedulernode.Resource, includeVolumes bool, requestedVolumes int, allocatableVolumes int) int64 {
