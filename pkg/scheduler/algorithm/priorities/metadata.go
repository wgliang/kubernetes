...
type priorityMetadata struct {
	nonZeroRequest          *schedulernode.Resource
...
func (pmf *PriorityMetadataFactory) PriorityMetadata(pod *v1.Pod, nodeNameToInfo map[string]*schedulernode.NodeInfo) interface{} {
