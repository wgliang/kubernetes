...
func ImageLocalityPriorityMap(pod *v1.Pod, meta interface{}, nodeInfo *schedulernode.NodeInfo) (schedulerapi.HostPriority, error) {
	node := nodeInfo.Node()
	if node == nil {
...
func sumImageScores(nodeInfo *schedulernode.NodeInfo, containers []v1.Container, totalNumNodes int) int64 {
	var sum int64
...
func scaledImageScore(imageState *schedulernode.ImageStateSummary, totalNumNodes int) int64 {
